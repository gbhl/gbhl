 ...
 * comments, bug reports are welcome crazylegs _AT_ gmail _DOT_ com
 * @author CraZyLeGs
 * @version 0.5.3
 * @license MIT
 */
...
*/
    ...
    var $logout_page   = '/users/logout';
    var $access_page   = '/bibs/index';
   ...
   function _login($params,$ignore_cookie = false)
   {
    ...
    function _checkLoginAttempts()
    {
        if($this->login_limit)
        {
            ...
            if (!class_exists($this->login_attempts_model))
            {
   ...
   function _aclCheckAccess($aro_alias, $aco)
   {
    ...
    function _createModel()
    {
        ...
        /* above good does the same thing
   ...
   function url($url = null)
   {
           ...
           // return Router::url($url, $full); for 1.2
   }
