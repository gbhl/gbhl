<?php
/* SVN FILE: $Id: session.php 4068 2006-12-04 21:02:36Z phpnut $ */
/**
 ...
 * @lastmodified	$Date: 2006-12-04 15:02:36 -0600 (Mon, 04 Dec 2006) $
 ...
 */
	...
	/** CJS Reverse Proxy Session Fix
	*
	* need to set
	* session.referer_check to the name of the reverse proxy host
	* that we use to present the application rather than $this->host
	*/
				// 	ini_set('session.referer_check', $this->host);
				 	ini_set('session.referer_check', 'www.nhm.ac.uk');
				}
			break;
			case 'medium':
